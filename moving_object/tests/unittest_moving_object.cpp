...
TEST(UnitTestMovingObject, processFrame_calcVelocity)
{
  ...
  TraObj_inbox_first.object = getObject("person", 0.8f);
  ...
  DetectionObjectInBox DetObj_inbox_second = getObjectInBox(60, 60, 110, 110, "person", 0.8f);
  detect->header.stamp = stamp;
  detect->header.frame_id = "test1";
  detect->objects_vector.push_back(DetObj_inbox_second);
  TrackingObjectInBox TraObj_inbox_second;
  TraObj_inbox_second.id = 1;
  TraObj_inbox_second.object = getObject("person", 0.8f);
  ...
  LocObj_inbox_second.object = getObject("person", 0.8f);
  ...
  DetectionObjectInBox DetObj_inbox_third = getObjectInBox(70, 70, 120, 120, "person", 0.8f);
  detect->header.stamp = stamp;
  detect->header.frame_id = "test1";
  detect->objects_vector.push_back(DetObj_inbox_third);
  TrackingObjectInBox TraObj_inbox_third;
  TraObj_inbox_third.id = 2;
  TraObj_inbox_third.object = getObject("person", 0.8f);
  ...
  LocObj_inbox_third.object = getObject("person", 0.8f);
